...
export const gameData = {
    ...
    scenes: [
        {
            ...
            items: ["torch", "rope", "butterfly", "gear", "key", "crossing", "gold_bars"]
        },
        {
            sceneName: "scene2",
            ...
            items: ["safe_door", "key", "map", "boat", "oar", "rope"]
        },
        {
    ...
    sceneItems: [
        ...
        },
        {
            ...
            combineWith: "gold_bars",
            combineResult: "map",
            combineMessage: "Combined to make map",
            combinePoints: 10,
            outcome: "remove",
            points: 15,
            position: [200, 136],
