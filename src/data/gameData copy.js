    ...
    scenes: [
        {
            ...
            textOne: "You find yourself standing at the entrance of a mysterious cave. The air is thick with anticipations.",
            stage: "Awakening",
            stageNumber: 1,
            sceneType: "scene",
            sceneMusic: "ambient1",
            backgroundColor: "#F4FED3",
            items: ["torch", "rope", "butterfly", "gear", "sea-one", "sea-two", "key", "map", "tower-one", "starburst-one"]
        },
        {
            sceneName: "scene2",
            ...
            items: ["safe_door", "rope",  "map", "boat", "oar"],
